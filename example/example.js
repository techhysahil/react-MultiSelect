      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'p',
            null,
            'React MultiSelect with search disabled using "showSearch" option'
          ),
          React.createElement(ReactMultiSelect, {
            categoryList: categoryList,
            categoryName: categoryName,
          ...
          React.createElement(
            'p',
            null,
            'React MultiSelect disabled using "disabled" option'
          ),
          React.createElement(ReactMultiSelect, {
            categoryList: categoryList,
            categoryName: categoryName,
          ...
          React.createElement(
            'p',
            null,
            'React MultiSelect with limiting maximum number of selection using "limitNoOfSelection" option to ant integer value less than length of datasource'
          ),
          React.createElement(ReactMultiSelect, {
            categoryList: categoryList,
            categoryName: categoryName,
